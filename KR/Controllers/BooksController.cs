...
namespace KR.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Author,ImgUrl,YearOfRelease,Description,DateAdd,State")] Book book)
        {
            ...
            States(book);
            book.DateAdd = DateTime.Now.Date;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Author,ImgUrl,YearOfRelease,Description,DateAdd,State")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookStoragePortalContext.Books'  is null.");
            }
            var book = await _context.Books.FindAsync(id);
            if (book != null)
            {
